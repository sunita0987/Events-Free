    ...
    <nav className="flex justify-between items-center px-6 py-4 bg-black">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-xl font-bold text-blue-500">
          Events<span className="text-cyan-300">Free</span>
        </span>
      </div>
      ...
      <button className="bg-blue-500 text-white px-4 py-1  hover:bg-blue-600  rounded-full text-sm ml-4 font-poppins font-semibold cursor-pointer">
        Log Out
      </button>
    </nav>
  );
